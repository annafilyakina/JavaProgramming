...
class Fraction {
    ...
    public Fraction sokratit(Fraction fraction) {
    ...
    public Fraction add(Fraction f1, Fraction f2) {
        ...
        return FinalFraction.sokratit(FinalFraction);
    }
    ...
    static public Fraction fromString(String stringFraction) throws MyException {
        ...
        if (numFrac[1] == 0) {
            throw new MyException("Знаментель не должен равняться 0");
        }
    ...
    public static List<String> parse(String expression) {// перевод в постфиксную запись (стринговый массив)
    ...
    public static Fraction calc(List<String> postfixExpression) {
        ...
        for (String x : postfixExpression) {
            ...
            } else if (x.equals("~")) { // минус не как операция
                Fraction f = stack.pop();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("постфиксная запись: " + parse(expression));
            System.out.println("результат вычисления: " + calc(parse(expression)));
        } catch (Exception ex) {
